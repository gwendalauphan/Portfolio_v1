...
const Stars = memo((props) => {
  ...
  const sphere = useMemo(() => {
    return random.inSphere(new Float32Array(6000), { radius: 6 });
...
const StarsCanvas = memo(({ showStarsCanvas }) => {
  ...
  return (
    <div className="w-full h-auto absolute inset-0 z-[-1]">
      ...
      >
        ...
        <Stars />
          {showStarsCanvas && <Earth controlsRef={controlsRef} setAngles={setAngles} />}
        </Suspense>
